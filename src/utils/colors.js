// Color system utilities based on your design tokens
export const colors = {
  gray: {
    25: "#FCFCFD",
    50: "#F9FAFB",
...
export const getColor = (colorName, shade = 500) => {
  const colorGroup = colors[colorName.toLowerCase()]
  if (!colorGroup) {
...
export const semanticColors = {
  ...
  info: colors.bluelight[500],
  
  // Text colors
  textPrimary: colors.gray[900],
  textSecondary: colors.gray[600],
  textTertiary: colors.gray[500],
  textInverse: colors.gray[25],
  
  // Background colors
  bgPrimary: colors.gray[25],
